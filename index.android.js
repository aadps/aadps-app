  ...
  render() {
    ...
    var navigationView = (
      <ScrollView style={styles.menu}>
        <Image style={styles.menuImage} resizeMode={Image.resizeMode.cover} source={require('./image/plane.jpg')}>
        ...
        <View style={styles.menuSeparator}></View>
        <TouchableHighlight activeOpacity={0.935} onPress={()=>{_navigator.push({id: 'user'});}}><View style={styles.menuItem}>
          <Image style={[styles.menuIcon, {tintColor: '#888888'}]}
            resizeMode={Image.resizeMode.stretch}
            source={require('image!ic_person_white_24dp')} />
          <Text style={styles.menuText}>注册/登录</Text>
        </View></TouchableHighlight>
      </ScrollView>
    );
...
class User extends React.Component {
  constructor(props) {
   ...
   render() {
     ...
     if (this.state.register)namefield =<View style={{backgroundColor: '#fff', flexDirection: 'row', height: 40, alignSelf: "stretch"}}>
